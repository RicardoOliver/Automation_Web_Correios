...
namespace SpecFlowProjectCepWeb.Common
{
    ...
    public class Hooks
    {
        ...
        private static readonly string PathReport = $"{AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug", "TestResults")}ExtentReportsBuscaCep.html";
        ...
        public string addScreenshot(IWebDriver driver, ScenarioContext scenarioContext)
        {
            ...
            string screenshotLocation = Path.Combine(PathReport, scenarioContext.ScenarioInfo.Title + ".png");
